...
class EditProfileDetailScreen extends BaseRoute {
  EditProfileDetailScreen({a, o})
      : super(a: a, o: o, r: 'EditProfileDetailScreen');
  @override
  _EditProfileDetailScreenState createState() =>
      _EditProfileDetailScreenState();
}

class _EditProfileDetailScreenState extends BaseRouteState {
  ...
  _EditProfileDetailScreenState() : super();

  @override
  Widget build(BuildContext context) {
    final auth = Provider.of<Auth>(context, listen: false);

    _cFirstName.text = auth.current_user['first_name'];
    _cLastName.text = auth.current_user['last_name'];
    return SafeArea(
      child: Container(
