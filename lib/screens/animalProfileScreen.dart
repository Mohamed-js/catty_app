...
class AnimalProfileScreen extends StatefulWidget {
  final int animal_id;
  const AnimalProfileScreen(this.animal_id);

  @override
  State<AnimalProfileScreen> createState() => _MyAnimalProfileScreenState();
}

class _MyAnimalProfileScreenState extends State<AnimalProfileScreen>
